    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../../ini/index.php">DAFTAR RUMAH SAKIT KOTA MALANG</a>
            </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    <b>DAFTAR RUMAH SAKIT KOTA MALANG</b>
                    <small>Taken from <a href="https://dinkes.malangkota.go.id/" target="_blank">dinaskesehatankotamalang</a></small>
                </h2>
            </div>
            <!-- Basic Examples -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					while($row = $data->fetch_array()){
					 ...
					 ?>
					 <tr>
					 	<td><?php echo $row['nama_lakes'];?>
					 	</td>
					 	<td><?php echo $row['alamat_lakes'];?>
					 	</td>
					 </tr>
					 <?php
					}
