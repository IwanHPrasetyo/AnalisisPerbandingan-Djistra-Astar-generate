    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../../ini/index.php">PROFIL</a>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#image_only_icon_title" data-toggle="tab">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="profile_only_icon_title">
                                    ...
                                    <i class="material-icons">person</i>
                                       <p> Devila Aprilia </p>
                                        ...
                                        <p> Mengambil jurusan Teknik Informatika di Universitas Kanjuruhan Malang </p>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="messages_only_icon_title">
                                    ...
                                    <p> devilaaprilia@gmail.com </p>
                                    <i class="material-icons">local_phone</i>
                                    <p> +6285230932851
                                    </p>
                                </div>
                                <div role="tabpanel" class="tab-pane fade" id="image_only_icon_title">
                                    <b>Image</b>
                                    <div class="image">
                                        <img src="../../images/devila.jpg" width="320" height="280" alt="User" />
                                     </div>
                                </div>
                            </div>
                        </div>
