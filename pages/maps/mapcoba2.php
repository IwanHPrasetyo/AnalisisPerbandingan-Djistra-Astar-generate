...
<head>
    ...
    <title>Google Maps - Generate and Test</title>
    ...
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB04Iha4MnlTVAvjGXQ_9vlQoH-ZTijq4U&callback=initMap">
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          ...
          center: {lat: -8.002103, lng: 112.619832},
        ...
        var flightPlanCoordinates = [
            ...
            do{
                ...
                $quejar = mysqli_query($conn,"SELECT sum(jarak) as j from generate where id_awal = '$aw' and rute=$rute and id_lakes = '$ak'");
                $datjar = mysqli_fetch_array($quejar);  
            ...
            //echo $jarak;
            $qrute = mysqli_query($conn,"SELECT * FROM (SELECT rute, sum(jarak) as j from generate where id_awal = '$aw' and id_lakes = '$ak' group by rute) as a  where j = $jarak");
            $qdata = mysqli_fetch_array($qrute);

            $idrute = $qdata['rute'];

            $query = mysqli_query($conn,"SELECT * from generate where id_awal = '$aw' and rute='$idrute' and id_lakes = '$ak' and node_awal='$node_aw'");
            ...
            $query2 = mysqli_query($conn,"SELECT * from generate where id_awal = '$aw' and rute='$idrute' and id_lakes = '$ak' and node_awal = '$node'");
    ...
    <div class="row clearfix">
        <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box-4">
                ...
                <div class="number count-to" data-from="0" data-to="257" data-speed="1000" data-fresh-interval="20">74,3 %</div>
            </div>
        </div>
    </div>
        <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
