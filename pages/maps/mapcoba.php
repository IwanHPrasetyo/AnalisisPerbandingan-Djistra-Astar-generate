    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html">GOOGLE MAPS</a>
            </div>
    ...
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB04Iha4MnlTVAvjGXQ_9vlQoH-ZTijq4U&callback=initMap">
      ...
      function initMap() {
        ...
        var flightPlanCoordinates = [
            ...
            $query = mysqli_query($conn,"SELECT * from a_star where id_awal = '$aw' and id_lakes = '$ak' and node_awal = '$node_aw' order by jarak limit 1");
            ...
            $query2 = mysqli_query($conn,"SELECT * from a_star where id_awal = '$aw' and id_lakes = '$ak' and node_awal = '$node' order by jarak limit 1");
