...
<head>
    ...
    <title>Analisis Perbandingan Algoritma</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../ini/index.php">ANALISIS PERBANDINGAN ALGORITMA</a>
            </div>
            ...
            <div class="block-header">
                <div class="card">
                    <div class="body bg-blue">
                            <h1><b>ANALISIS PERBANDINGAN ALGORITMA DJIKSTRA, A STAR (A*) DAN GENERATE AND TEST DALAM MENENTUKAN AKSES TERCEPAT KE LOKASI LAYANAN KESEHATAN KODYA MALANG </b></h1>
                    </div>
                </div>
            </div>                    
        </div>
